...
export default function Page() {
  ...
  return (
    <>
      ...
      <div className="bg-foreground flex flex-col gap-2 p-8 md:p-10">
        <IntersectionObserverComp triggerOnce={true} threshold={1} originalClass="invisible" addedClass={classToAdd}>
          <h1 className="font-KBODiaGothic_bold text-background text-3xl font-extrabold tracking-tighter md:text-4xl">
            Beautifully designed components <br className="hidden sm:inline" />
            built with Radix UI and Tailwind CSS.
          </h1>
        </IntersectionObserverComp>
